...
import AllStadiums from './data'
import AuthenticationScreen from './screens/AuthenticationScreen'
import LocalStorage from './state/LocalStorage'
import RootNavigation from './navigation/RootNavigation'
import Store from './state/Store'
import { Stadium, User } from './state/Records'
...
class App extends React.Component {
    ...
    _loadCacheAsync = async () => {
        ...
        let stadiums = new List(AllStadiums.map(data => new Stadium(data)))
        let visitedStadiums = new List(
            await LocalStorage.getVisitedStadiumsAsync()
        )
        this.props.dispatch(Actions.setCurrentUser(user))
        this.props.dispatch(Actions.setStadiums(stadiums))
        this.props.dispatch(Actions.setVisitedStadiums(visitedStadiums))
    }
