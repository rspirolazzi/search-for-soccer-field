...
export class MapCard extends React.Component {
    ...
    render() {
        let {address, state, name} = this.props.stadium;
    ...
    _maybeRenderMap() {
        ...
        let {name, location} = this.props.stadium;
...
export class VisitedCard extends React.Component {
    static getDataProps(data, props) {
        let {stadiumId} = props;
        let isVisited = data.stadiums.visited.includes(stadiumId);
    ...
    _onToggleVisited = () => {
        if (this.props.isVisited) {
            this.props.dispatch(Actions.removeVisitedStadium(this.props.stadiumId));
        } else {
            this.props.dispatch(Actions.addVisitedStadium(this.props.stadiumId));
        }
    };
