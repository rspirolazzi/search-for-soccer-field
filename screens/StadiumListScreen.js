...
@connect()
export default class StadiumListScreen extends React.Component {
  static route = {
    navigationBar: {
      visible: false,
    },
  ...
  render() {
    ...
    return (
        <View style={styles.container}>
          {selectedOption === 'All' && <StadiumList {...defaultListProps} />}
          {selectedOption === 'Nearby' && (
              <StadiumList {...defaultListProps} nearby />
          )}
          {selectedOption === 'Visited' && (
              <StadiumList {...defaultListProps} visited />
          )}
          {selectedOption === 'Unvisited' && (
              <StadiumList {...defaultListProps} notVisited />
          )}
            ...
            <TouchableWithoutFeedback
              ...
              <View style={{ flexDirection: 'row' }}>
                <BoldText style={styles.navigationBarTitle}>
                  {this.state.selectedOption} Stadiums
                </BoldText>
